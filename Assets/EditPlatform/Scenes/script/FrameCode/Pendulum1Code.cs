...
public static class Pendulum1Code
{
    ...
    public static string afterClassName = " : MonoBehaviour\n" +
        ...
        "        fixedPos = SpacefixP.transform.position;\n" +
        ...
        "        SpaceLine.transform.position = linePos;\n" +
        "        SpaceLine.transform.Rotate(new Vector3(0, 0, angle * Mathf.Rad2Deg));\n" +
        "    }\n" +
        "}\n";
