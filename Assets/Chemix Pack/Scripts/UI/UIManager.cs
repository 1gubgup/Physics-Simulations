...
namespace Chemix.UI
{
    public class UIManager : Singleton<UIManager>
    {
        ...
        public void DisplayFocus(GameObject owner, Vector3 offset = default)
        {
            if (!focusInstance)
            {
            ...
            focusInstance.transform.position = ChemixEngine.Instance.mainCamera.WorldToScreenPoint(owner.transform.position + offset);
            focusOwner = owner;
        }
